...
const Repositories = () => {
  return (
    <div>
      <section>
        <h2 className="font-semibold text-3xl text-white">My Projects</h2>
        <div className="grid grid-cols-2 gap-2 mt-4">
          <div className="cursor-pointer shadow-lg border rounded-md border-opacity-25">
            <div className="flex flex-col justify-between p-4 space-y-2.5">
              <div className="flex items-center justify-between">
                <span className="text-white font-semibold">website</span>
              </div>
              <p className="text-white overflow-hidden font-sans">
                🎉 They are the source code for my personal web page...
              </p>
              <div className="mt-3 flex justify-left items-center space-x-2">
                <svg
                ...
                <Link
                  href="https://github.com/itarikahmed"
                  className="no-underline"
                >
                  <p className=" py-1 px-1 rounded border border-white inline text-base m-1">
                    Source Code
                  </p>
                </Link>
                <Link
                  ...
                  className="no-underline"
                >
                  <p className=" p-1 rounded border border-white inline text-base m-1">
                    Live Preview
                  </p>
                </Link>
              </div>
          ...
          <div className="cursor-pointer shadow-lg border rounded-md border-opacity-25">
            <Link
              href="https://github.com/AdemCanCertel/netflix-desktop"
              className="no-underline"
            >
          ...
          <div className="cursor-pointer shadow-lg border rounded-md border-opacity-25">
            <Link
              href="https://github.com/AdemCanCertel/portfolio"
              className="no-underline"
            >
              <div className="flex flex-col justify-between p-2">
                <div className="flex items-center justify-between">
                ...
                <p className="text-white overflow-hidden font-sans">
                  Easy developer portfolio NuxtJS and TailwindCSS and discord
                  status lanyard.
                </p>
                <div className="mt-1">
                  <svg
          ...
          <div className="cursor-pointer shadow-lg border rounded-md border-opacity-25">
            <Link
              href="https://github.com/AdemCanCertel/whatsapp-ui-clone"
              className="no-underline"
            >
              <div className="flex flex-col justify-between p-2">
                <div className="flex items-center justify-between">
                ...
                <p className="text-white overflow-hidden font-sans">
                  A simple UI clone I made with HTML, CSS
                </p>
                <div className="mt-1">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
